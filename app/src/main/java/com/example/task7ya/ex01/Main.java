...
public class Main
{
    public static void main(String[] args) {
        ...
        allEmployees.add(new Manager(1, "darya hamalca", 9000000.9999, "Sales", 99999.9999));
        allEmployees.add(new Salesperson(2, "Shelly fux", 40000, 0.08, 500));
        allEmployees.add(new HourlyEmployee(3, "Gili", 300, 80));
        allEmployees.add(new HourlyEmployee(4, "Noa", 300, 120));
        allEmployees.add(new HourlyEmployee(5, "Shay", 500, 20));
